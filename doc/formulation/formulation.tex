...
formal languages  that ensures the specification has a
...
by a single initial condition or by a set of initial conditions.
Even though there exists a theory on the often related problem of optimal
control for PDEs (see \cite{}), to the best of our knowledge, the verification 
of complex properties in systems governed by a PDE has not been explored before.
...
conservative reformulation that follows the same approximation and
...
\section{Heat Equation and Finite Element Method}
...
to a simplified heat equation. A more detailed exposition can be found in any
