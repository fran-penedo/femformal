...
\begin{abstract}
    ...
    specifications for partial differential equations. We leverage the finite
...
Note that the problem formulation is not tied to a 1D heat equation. One can
easily adapt our STL extension to any PDE, although we require in what follows
that the FEM method can be applied to the system and the resulting system of
ODEs is linear.
