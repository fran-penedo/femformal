...
# apc4 = logic.APCont([35000, 55000], "<", lambda x: 4 * x / 100000.0 + 1.5 , lambda x: 4 / 100000.0)
# apc5 = logic.APCont([65000, 90000], "<", lambda x: 2 * x / 100000.0 + 1.0 , lambda x: 2 / 100000.0)
...
cregions = {'A': apc1, 'B': apc2, 'C': apc3, 'D': apc4, 'E': apc5}

# cspec = "((F_[1, 10] (A)) & (G_[1, 10] (B)))"
# cspec = "(F_[1, 10] (A))"
cspec = "((F_[0.0, 0.3] ((A) & (C))) & (G_[0.0, 0.3] ((D) & (E))))"
