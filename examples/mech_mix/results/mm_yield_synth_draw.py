...
inputs = [-5000.00000000000, 5000.0, -5000.00000000000, 5000.0, -5000.00000000000, 5000.0, 5000.0]
input_dt = .05
pwlf = sys.PWLFunction(np.linspace(0, (len(inputs) - 1) * input_dt, len(inputs)),
                       inputs, ybounds=[-5e5, 5e5], x=L)
...
# Robustness = 0.000204231615664
# Synthesized parameters = [-5000.000000000002, 5000.0, -5000.000000000002, 5000.0, -5000.000000000002, 5000.0, 5000.0]
# Time = 60.2869069576
